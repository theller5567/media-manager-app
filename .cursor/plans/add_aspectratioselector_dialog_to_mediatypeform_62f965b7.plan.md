...
todos:
  - id: refactor-aspect-ratio-selector
    content: Refactor AspectRatioSelector to support props and onSave callback
    status: completed
  - id: update-media-type-definition
    content: Add dimension constraints to MediaType type definition if missing
    status: completed
  - id: integrate-dialog-to-form
    content: Integrate AspectRatioSelector into a Dialog in MediaTypeForm Step 2
    status: completed
  - id: add-summary-and-clear-ui
    content: Add summary UI and clear functionality to MediaTypeForm step 2
    status: completed
isProject: false
---
