...
let mockMediaDataStore: MediaItem[] = [
  {
    id: "1",
...
// Export the array (can be mutated for adding items)
export const mockMediaData = mockMediaDataStore;

/**
 * Add media items to the mock data store
 * In production, this would be a Convex mutation
 */
export function addMediaItems(items: MediaItem[]): void {
  mockMediaDataStore.unshift(...items);
}
